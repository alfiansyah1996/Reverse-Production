...
if process:
	...
	join_5['gap_stock_fg_to_target']=(join_5['target_stock_for_fg']-join_5['Finished_Goods_Storage']).apply(np.ceil)
	...
	join_5 = join_5.drop_duplicates(subset='sku_number', keep="last")
